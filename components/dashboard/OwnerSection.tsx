    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="text-center">
          <p className="text-3xl font-bold text-brand-600">{postedJobs.length}</p>
          <p className="text-sm text-slate-600 mt-1">Posted Jobs</p>
        </Card>
        <Card className="text-center">
        ...
        <Card className="text-center">
          <p className="text-3xl font-bold text-amber-600">$2,150</p>
      ...
      {postedJobs.length > 0 ? (
        <div className="space-y-3">
          <h3 className="text-sm font-medium text-slate-700">Your Recent Jobs</h3>
