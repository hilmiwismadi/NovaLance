...
export default function ApplicationsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-slate-900">My Applications</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="text-center">
          ...
          <p className="text-sm text-slate-600 mt-1">Accepted</p>
        </Card>
        <Card className="text-center">
      ...
      {mockApplications.length > 0 ? (
        <div className="space-y-4">
          {mockApplications.map((application) => (
            <Card key={application.id} className="hover:bg-slate-50 transition-all">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="bg-slate-50 rounded-xl p-3 mt-3">
                    <p className="text-sm text-slate-700 italic">"{application.coverLetter}"</p>
                  </div>
                </div>
        ...
        <Card className="text-center py-12">
          ...
          <p className="text-slate-600 mb-6">Start browsing jobs and submit your first application!</p>
          <Link href="/jobs">
      ...
      <Card className="border-brand-200">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-slate-900 mb-1">Tips for Better Applications</h3>
