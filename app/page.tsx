  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-white/60">Here's what's happening with your projects and applications.</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-white/90">Milestone "Design Phase" approved</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-white/90">New application from bob.eth</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-white/90">Payment of $150 USDC received</p>
